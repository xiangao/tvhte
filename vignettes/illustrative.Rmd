...
response to past outcomes. We fit the structural TV-HTE model
(Botosaru and Liu 2025), the homogeneous feedback model (Botosaru and
Liu 2026), and use both to decompose dynamic event-study responses
into direct vs indirect components.
